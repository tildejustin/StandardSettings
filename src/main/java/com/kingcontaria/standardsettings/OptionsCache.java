...
public class OptionsCache {
    ...
    private final double[] soundCategories;
    ...
    public OptionsCache(MinecraftClient client) {
        ...
        soundCategories = new double[SoundCategory.values().length];
    ...
    public void load(String levelName) {
        ...
        for (SoundCategory soundCategory : SoundCategory.values()) {
            options.getSoundVolumeOption(soundCategory).setValue(soundCategories[i++]);
        }
        i = 0;
        for (PlayerModelPart playerModelPart : PlayerModelPart.values()) {
